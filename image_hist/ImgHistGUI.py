...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.img_hist_btn = QtWidgets.QPushButton("Hist Image")
        self.img_hist_btn.setObjectName("change")
        self.img_hist_btn.clicked.connect(self.ImageHist)
        self.horizontalLayout.addWidget(self.img_hist_btn)
    ...
    def ImageHist(self):
        ...
        mask = np.ones((256, 256 * 3, 3),dtype='uint8')
        ...
        for i in range(256):
            ...
            print height
        self.hist_img = cv2.cvtColor(mask,cv2.COLOR_BGR2RGB)
        self.qimage = QtGui.QImage(self.hist_img.data, self.hist_img.shape[1], self.hist_img.shape[0],
                                   QtGui.QImage.Format_RGB888)
        self.output.setPixmap(QtGui.QPixmap.fromImage(self.qimage))
